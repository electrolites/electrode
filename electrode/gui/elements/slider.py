...
class Slider(wx.Slider):
	def __init__(self, parent, label: str, minValue: int = 0, maxValue: int = 100, initialValue: int = 0, onChange: Coroutine | None  = None, vertical: bool = True):
		...
		if onChange is not None:
			AsyncBind(wx.EVT_SLIDER, onChange, self)
